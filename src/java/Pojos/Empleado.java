...
public class Empleado  implements java.io.Serializable {
    ...
    public Empleado(Ciudad ciudad, Rol rol, Tipodocumento tipodocumento, String numeroDocumento, String nombre, String apellidos, int edad, boolean genero, Date fechaNacimiento, String correoElectronico, String password, Date fechaIngreso, String telefono, String direccion, String imgPrincipal, Set abonosecundarios, Set abonoses, Set cotizacions, Set facturases, Set sueldos) {
       this.ciudad = ciudad;
       this.rol = rol;
       this.tipodocumento = tipodocumento;
       this.numeroDocumento = numeroDocumento;
